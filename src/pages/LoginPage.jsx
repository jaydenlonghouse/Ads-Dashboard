        ...
        <div className="w-full max-w-[26rem]">
          ...
          <div className="mb-10 flex flex-col items-center text-center">
            <img
              ...
              decoding="async"
            />
            <p className="mt-4 text-sm font-medium tracking-wide text-brand-200/90">
          ...
          <div className="rounded-2xl border border-white/10 bg-white p-8 shadow-2xl shadow-black/25 sm:p-9">
            <div className="space-y-1 text-center sm:text-left">
              ...
              <p className="text-sm leading-relaxed text-ink-600">
                Sign in to view campaign performance, KPIs, and linked deals.
              </p>
            </div>
          ...
          <p className="mt-8 text-center text-xs leading-relaxed text-brand-300/70">
            Internal reporting for Longhouse Advertising.
            <br />
